...
export const ThreeDPrinterCanvas: React.FC = () => {
  ...
  return (
    <div id="additive-simulator" className="w-full bg-slate-950 border border-slate-700/80 rounded-2xl overflow-hidden shadow-2xl relative">
      ...
      <div className="relative w-full h-[420px] sm:h-[500px] cursor-grab active:cursor-grabbing bg-radial from-slate-900 to-[#070a0f]">
